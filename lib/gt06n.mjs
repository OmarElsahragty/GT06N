...
const parseLogin = (packet) => ({
  event: "login",
  imei: parseInt(packet.substr(8, 16), 16),
  serialNumber: packet.substr(22, 4),
  errorCheck: packet.substr(26, 4),
...
const parseLocation = (packet) => {
  ...
  return {
    event: "location",
    date: parseDate(parseDate(packet.substr(8, 12))),
